...
export class ProjectDetailComponent implements OnInit { 
	...
	ngOnInit(): void {	
			...
			project1 =>{
				this.project=project1[0];console.log("api return");console.log(this.project[0]);this.title=project1[0].name;this.projectDetails=project1[0]},
